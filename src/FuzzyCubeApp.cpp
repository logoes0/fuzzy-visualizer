...
namespace CubeData {
    ...
    // Colors match low-quality cube for consistency across quality levels
    float cubeVertices[] = {
        // positions          // normals           // colors
        // Back face (normal: 0, 0, -1) - Purple
        -0.5f, -0.5f, -0.5f,  0.0f,  0.0f, -1.0f,  0.6f, 0.2f, 0.8f,  // 0
         0.5f, -0.5f, -0.5f,  0.0f,  0.0f, -1.0f,  0.6f, 0.2f, 0.8f,  // 1
         0.5f,  0.5f, -0.5f,  0.0f,  0.0f, -1.0f,  0.6f, 0.2f, 0.8f,  // 2
        -0.5f,  0.5f, -0.5f,  0.0f,  0.0f, -1.0f,  0.6f, 0.2f, 0.8f,  // 3
        
        // Front face (normal: 0, 0, 1) - Red-orange
        -0.5f, -0.5f,  0.5f,  0.0f,  0.0f,  1.0f,  0.9f, 0.3f, 0.2f,  // 4
         0.5f, -0.5f,  0.5f,  0.0f,  0.0f,  1.0f,  0.9f, 0.3f, 0.2f,  // 5
         0.5f,  0.5f,  0.5f,  0.0f,  0.0f,  1.0f,  0.9f, 0.3f, 0.2f,  // 6
        -0.5f,  0.5f,  0.5f,  0.0f,  0.0f,  1.0f,  0.9f, 0.3f, 0.2f,  // 7
        
        // Left face (normal: -1, 0, 0) - Yellow-orange
        -0.5f, -0.5f, -0.5f, -1.0f,  0.0f,  0.0f,  0.9f, 0.7f, 0.2f,  // 8
        -0.5f, -0.5f,  0.5f, -1.0f,  0.0f,  0.0f,  0.9f, 0.7f, 0.2f,  // 9
        -0.5f,  0.5f,  0.5f, -1.0f,  0.0f,  0.0f,  0.9f, 0.7f, 0.2f,  // 10
        -0.5f,  0.5f, -0.5f, -1.0f,  0.0f,  0.0f,  0.9f, 0.7f, 0.2f,  // 11
        
        // Right face (normal: 1, 0, 0) - Green
         0.5f, -0.5f, -0.5f,  1.0f,  0.0f,  0.0f,  0.2f, 0.8f, 0.3f,  // 12
         0.5f, -0.5f,  0.5f,  1.0f,  0.0f,  0.0f,  0.2f, 0.8f, 0.3f,  // 13
         0.5f,  0.5f,  0.5f,  1.0f,  0.0f,  0.0f,  0.2f, 0.8f, 0.3f,  // 14
         0.5f,  0.5f, -0.5f,  1.0f,  0.0f,  0.0f,  0.2f, 0.8f, 0.3f,  // 15
        
        // Bottom face (normal: 0, -1, 0) - Cyan
        -0.5f, -0.5f, -0.5f,  0.0f, -1.0f,  0.0f,  0.2f, 0.8f, 0.8f,  // 16
         0.5f, -0.5f, -0.5f,  0.0f, -1.0f,  0.0f,  0.2f, 0.8f, 0.8f,  // 17
         0.5f, -0.5f,  0.5f,  0.0f, -1.0f,  0.0f,  0.2f, 0.8f, 0.8f,  // 18
        -0.5f, -0.5f,  0.5f,  0.0f, -1.0f,  0.0f,  0.2f, 0.8f, 0.8f,  // 19
        
        // Top face (normal: 0, 1, 0) - Blue
        -0.5f,  0.5f, -0.5f,  0.0f,  1.0f,  0.0f,  0.3f, 0.4f, 0.9f,  // 20
         0.5f,  0.5f, -0.5f,  0.0f,  1.0f,  0.0f,  0.3f, 0.4f, 0.9f,  // 21
         0.5f,  0.5f,  0.5f,  0.0f,  1.0f,  0.0f,  0.3f, 0.4f, 0.9f,  // 22
        -0.5f,  0.5f,  0.5f,  0.0f,  1.0f,  0.0f,  0.3f, 0.4f, 0.9f   // 23
    };
